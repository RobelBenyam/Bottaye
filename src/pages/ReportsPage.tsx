      ...
      <div className="flex items-center justify-between mb-2">
        <div>
          ...
          <p className="text-secondary-600 dark:text-secondary-400 mt-1">
            Analyze performance and generate insights for your properties.
          </p>
        </div>
          ...
          <table className="min-w-full">
            ...
            <tbody>
              {mockReportData.properties.map((property, index) => (
                <tr
                  key={index}
                  className="border-b border-secondary-100 dark:border-secondary-700 hover:bg-secondary-50 dark:hover:bg-secondary-700"
                >
                  ...
                  <td className="py-3 px-4">
                    <div className="flex items-center">
                      <span className="text-secondary-900 dark:text-secondary-100 mr-2">
                        {property.occupancy}%
                      </span>
        ...
        {reportTypes.map((report) => (
          <div key={report.id} className="card-hover">
            <div className="flex items-center justify-between mb-4">
              <div
                className={`p-3 rounded-lg bg-${report.color}-100 dark:bg-${report.color}-900/20`}
              >
                <report.icon
                  className={`h-6 w-6 text-${report.color}-600 dark:text-${report.color}-400`}
                />
              </div>
              <button className="btn-secondary px-3 py-1 text-sm">
